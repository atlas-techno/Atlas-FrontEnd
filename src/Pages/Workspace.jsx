...
export default function Workspace() {
    ...
    function createEc2(event) {
        ...
        if (listSubnet.length > 0) {
            ...
            axios.post("https://api.atlastechnologies.cloud/" + currentUser + "/" + idWk + "/create_ec2", ec2,)
                .then((r) => {
                    console.log(r)
                    setLoading(false)
                    setLoadingDe(false)
    ...
    function createVpc() {
        ...
        if (vpc.name === "") {
            ...
            axios.post("https://api.atlastechnologies.cloud/" + currentUser + "/" + idWk + "/create_vpc", vpc)
                .then((r) => {
                    console.log(r)
                    setLoading(false)
                    setLoadingDe(false)
    ...
    function createSubnet(event) {
        ...
        if (listWS.length > 0) {
            ...
            if (subnet.vpc_name === 0) {
                ...
                axios.post("https://api.atlastechnologies.cloud/" + currentUser + "/" + idWk + "/create_subpub", subnet)
                    .then((r) => {
                        console.log(r)
                        setLoading(false)
                        setLoadingDe(false)
    ...
    function deployEc2(event) {
        ...
        axios("https://api.atlastechnologies.cloud/" + currentUser + "/" + idWk + "/deploy")
            .then((r) => {
                console.log(r)
                setLoading(false)
                setLoadingD(false)
    ...
    function destoryEC2() {
        ...
        axios("https://api.atlastechnologies.cloud/" + currentUser + "/" + idWk + "/destroy")
            .then((r) => {
                console.log(r)
                setLoading(false)
                setLoadingDe(true)
    ...
    function ListarVpcs() {
        axios("https://api.atlastechnologies.cloud/" + idWk + "/query_vpcs")
            .then((r) => {
                console.log(r.data)
                setListWS(r.data)
            })
    ...
    function ListarSubs() {
        ...
        axios("https://api.atlastechnologies.cloud/" + idWk + "/query_subnets")
            .then((r) => {
                console.log(r)
    ...
    function ListarEc2s() {
        axios("https://api.atlastechnologies.cloud/" + idWk + "/query_instances")
            .then((r) => {
                console.log(r.data)
                setListEc2(r.data)
            })
