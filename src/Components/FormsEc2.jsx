...
function FormsEc2() {
  ...
  function createEc2(event) {
    ...
    axios.post('https://api.atlastechnologies.cloud:403/create-ec2', ec2,)
      .then((r) => {
        console.log(r)
  ...
  function deployEc2(event) {
    ...
    axios('https://api.atlastechnologies.cloud:403/deploy')
      .then((r) => {
        console.log(r)
  ...
  function destoryEC2(event) {
    ...
    axios('https://api.atlastechnologies.cloud:403/destroy')
      .then((r) => {
        console.log(r)
